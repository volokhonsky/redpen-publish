 ...
 *
 * Панель со списком замечаний приезжает уже отрендеренной из сборки — это то,
 * что индексируют поисковики. Этот скрипт её оживляет и НИЧЕГО не загружает:
 * все замечания страницы, включая черновики, лежат в инлайновом
...
(function () {
  ...
  function isDefaultView(shown) {
    // Пре-рендер содержит ровно опубликованные замечания в исходном порядке.
