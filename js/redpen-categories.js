/**
 * Категория замечания — один из шести приёмов пропаганды либо «Прочее».
 *
...
(function (global) {
  ...
  // 337 замечаниях и означает четыре разные вещи — разбор в доке.
  ...
  /**
   * Категория замечания: готовое поле, ровно одно значение.
   *
   ...
   * до перехода, и такое замечание показывается как «Прочее».
   */
